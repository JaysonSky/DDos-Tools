...
try:
    print("\033[1;36m================================")
    print("\033[1;36m[Project:M-Find] ")
    print("\033[1;36m[Author:MiYaww] ")


    print("\033[1;36m[ www.facebook.com/MiYaww.cat ] ")
    print("\033[1;36m================================")
    var1=0
    var2=0

    admin = ['admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','cpanel/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/','memberadmin/','administratorlogin/','adm/','admin/account.cfm','admin/index.cfm','admin/login.cfm','admin/admin.cfm','admin/account.cfm',
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    try:
        ...
        conn.connect()
        print "[Status-Ok] [ Server is Online/Valid Url.]"
    except (httplib.HTTPResponse, socket.error) as Exit:
        raw_input("[Status-Not Ok] [ Server Offline/Invalid Url]")
        exit()
    print "Choose: "
    print "1- find admin"
    ...
    if code==1:
        pass
        print("[Loading] Scanning " + site + "...")
        for admin in admin:
            admin = admin.replace("\n","")
            admin = "/" + admin
            host = site + admin
            print ("\t [Wait] Checking " + host + "...")
            ...
            connection.close()
        print("\n\nCompleted \n")
        print var1, "\033[1;36m[Admin pages found!!]"
        print var2, " [[Total pages scanned]] "
        raw_input("No pages are Matched..Press Any Key To Exit")
except (httplib.HTTPResponse, socket.error):
    print "\033[1;32m[ Session Cancelled!!; Error occured. Check internet settings ]"
except (KeyboardInterrupt, SystemExit):
    print "\033[1;36m [Cancelled!!]"
